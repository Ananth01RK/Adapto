        ...
        <div class="row">
            <div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">List of Pending Accounts</div>
					<div class="panel-body">
						<div class="table-responsive">
							<table id="myTable" class="table table-bordered js-basic-example dataTable myTable">
								...
								<tbody>
									<?php if($datas = fetchData(array("table" =>"staffs","condition" =>"WHERE staff_status='0' AND fname!=''"))): ?>
										<?php $count = 1; foreach($datas as $data): ?>
											<tr>
												<th><?php echo $count; ?></th>
												<td>
													<?php if($sys_users = fetchData(array("table" =>"system_users","condition" =>"WHERE sysu_id=".$data['sysu_id']))): $sys_user =$sys_users[0]; ?>
												...
												<td>
													<a href="/adapto/admin/user/lab_staff/pending_process.php?id=<?php echo $data["id"]; ?>" class="btn btn-success btn-width">
